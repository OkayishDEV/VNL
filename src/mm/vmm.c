/*
 * virtual memory manager... pml4 mess.
 * walking the tables... like walking through glass.
 */
#include "vmm.h"
#include "pmm.h"
#include "string.h"
...
/* allocate a frame for a table... don't run out of ram */
...
/* walk the tables rooted at root_phys... hope you don't trip */
...
void vmm_map(uint64_t virt, uint64_t phys, uint64_t flags)
{
    ...
    *pte = (phys & PAGE_MASK) | flags | VMM_FLAG_PRESENT;
    /* kill the tlb entry... die die die */
